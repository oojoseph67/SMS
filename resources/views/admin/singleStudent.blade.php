...
@extends('layouts.adminvertical', ['title' => 'Student'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('view.students') }}">View Student</a></li>
                            <li class="breadcrumb-item active">Student</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Single Student</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" role="form" action="{{ route('update.student') }}" enctype="multipart/form-data" class="col-7">
                            @csrf
