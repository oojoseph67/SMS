@extends('layouts.fees', ['title' => 'PTA Fees'])
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mt-3">
                                ...
                                <h4 class="text-muted"><b>Congragulations on paying your pta fees. Hope you have a blast term </b></h4>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mt-4 table-centered" id="datatable-buttons">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$details->class}}</td>
                                        <td class="text-right">{{$details->pta_fees_price}}</td>
                                    </tr>
