            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mt-3">
                                ...
                                <h4 class="text-muted"><b>Congragulations on paying your schools fees. Hope you have a blast term </b></h4>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table mt-4 table-centered" id="datatable-buttons">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$details->class}}</td>
                                        <td class="text-right">{{$details->school_fees_price}}</td>
                                    </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="float-right">
                                <h3>#{{$details->school_fees_price}}</h3>
                            </div>
