@extends('layouts.teachervertical', ['title' => 'Profile'])
                ...
                @endif        
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="settings">
                            <form action="{{ route('profile.teacherDetailsUpdate') }}">
                                ...
                                <h5 class="mb-3 text-uppercase bg-light p-2"><i class="mdi mdi-office-building mr-1"></i> Staff Info</h5>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="student_id">Staff ID</label>
                                            <input type="text" class="form-control" id="companyname" value="{{auth()->user()->staff_id}}" disabled>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane" id="aboutme">
                            <form action="{{ route('profile.teacherPasswordUpdate') }}">
