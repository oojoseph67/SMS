        ...
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="{{ route('exam.createBoth') }}">
                        ...
                        <label for="" class="col"><strong>Select Mark range for Obj Question</strong></label><br>
                        <div class="row">
                            
                            <div class="form-group col-md-5">
                                <label for="">Mark Per Right Question</label>
                                <select name="mark_right_obj" id="" required class="form-control">
                            ...
                            <!-- <div class="form-group col-md-5">
                                ...
                                <select name="mark_wrong_obj" id="" required class="form-control">
                                    <option value="">-Choose-</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="5">5</option>
                        ...
                        <label for="" class="col"><strong>Select Mark range for Theory Question</strong></label><br>
                            <div class="row">                            
                                <div class="form-group col-md-5">
                                    <label for="">Mark Per Right Question</label>
                                    <select name="mark_right_theory" id="" required class="form-control">
                                        <option value="">-Choose-</option>
                                ...
                                <!-- <div class="form-group col-md-5">
                                    <label for="">Mark Per Wrong Question</label>
                                    <select name="mark_wrong_theory" id="" required class="form-control">
                                        <option value="">-Choose-</option>
                                        <option value="10">10</option>
                                        <option value="15">15</option>
                                        <option value="17.5">17.5</option>
