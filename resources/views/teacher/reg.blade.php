...
<html lang="en">
    <head>
        @include('layouts.shared.title-meta', ['title' => "Register & Signup Teacher"])
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <form method="post" role="form" action="{{ route('register.teacher') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group{{ $errors->has('cv') ? ' has-danger' : '' }}">
                                ...
                                <input type="file" data-plugins="dropify"  name="cv"  value="{{ old('cv') }}"/>   
