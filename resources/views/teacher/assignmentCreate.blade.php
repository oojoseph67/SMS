        ...
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <form action="{{ route('assignment.create') }}">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="basic-datepicker" required name="date" class="form-control" placeholder="Basic datepicker">
                        </div>
                        ...
                        <div class="form-group col-md-5">
                            <button type="submit" class="form-control btn btn-primary">Create Assignment</button>
                        </div>
                    </form>
