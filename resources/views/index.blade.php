                        ...
                        <div class="shadow bg-white mt-4 p-2 rounded">
                            <a href="" class="text-dark">
                                ...
                                <div class="my-2 text-center">
                                    <a class="btn btn-success font-weight-bold btn-sm" href="" target="_blank">Light</a>
                                    <a class="btn btn-success font-weight-bold btn-sm" href="" target="_blank">Dark</a>
                                    <a class="btn btn-success font-weight-bold btn-sm" href="" target="_blank">RTL</a>
                                </div>
                            </a>
                        </div>
                    </div>
